...
## Project Initiation
Design an android mobile app that can help drivers improve their driving behaviour using flutter and deploy on Google PlayStore. This project was partially inspired by generated input from ChatGPT AI.
...
## Acknowledgement
We would like to acknowledge the use of ChatGPT, an AI language model developed by OpenAI, for assisting in the conceptualisation of our mobile application idea for this case study. The suggestions generated by ChatGPT had greatly helped us in initial stages of brainstorming and project design of SafeDrive while also provided us insights on how to develop this application.

## References
- OpenAI. (2024). ChatGPT [Computer software]. Retrieved from https://openai.com/chatgpt
