...
## Acknowledgement
We would like to acknowledge the use of ChatGPT, an AI language model developed by OpenAI, for assisting in the conceptualisation of our mobile application idea for this case study. The suggestions generated by ChatGPT had greatly helped us in initial stages of brainstorming and also for the project design of SafeDrive. 
